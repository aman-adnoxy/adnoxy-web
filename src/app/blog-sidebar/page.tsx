...
export const metadata: Metadata = {
  ...
  description: "This is Blog Details Page for ADNOXY",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              ...
              Experience the Future of Advertising – Partner with Us Today!
                ...
                <div>
                  ...
                  Maximizing Impact with Offline Advertising: Engaging Customers Beyond Screens for Stronger Brand Connections and Real-World Influence.
                  </p>
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/images/blog/blog-033.jpg"
                        alt="image"
                        fill
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    ...
                    As technology evolves, the possibilities for offline storytelling expand. Brands can now integrate interactive materials, augmented reality, and cutting-edge installations to create even more engaging experiences. The future promises exciting developments.
                    </p>
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 mt-12 rounded-sm bg-white p-6 dark:shadow-none lg:mt-0">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-sm bg-red-600 text-white"
