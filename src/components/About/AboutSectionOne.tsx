...
const AboutSectionOne = () => {
  const List = ({ text }) => (
    <p className="mb-5 flex items-center text-lg font-medium text-red-600">
  <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-red-200 text-red-600">
    {checkIcon}
  </span>
  {text}
</p>
  ...
  return (
    <section id="about" className="pt-16 md:pt-20 lg:pt-28">
      ...
      <div className="border-b border-black pb-16 dark:border-red-600 md:pb-20 lg:pb-28">
