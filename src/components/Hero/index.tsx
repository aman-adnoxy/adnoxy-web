...
const Hero = () => {
  return (
    <>
      <section
  id="home"
  className="relative z-10 overflow-hidden bg-[#ffffff] dark:bg-[#000000] h-[100vh] pb-16 pt-[120px] md:pb-[120px] md:pt-[150px] xl:pb-[10rem] xl:pt-[10rem]"
>
  <div className="container flex flex-col md:flex-row h-full">
    ...
    <div className="w-full md:w-1/2 px-4 flex items-center justify-center">
      <div className="relative mx-auto max-w-[500px] h-[70vh]">
        <img
          src="/images/about/image.png"
          alt="about-image"
          className="w-full max-w-[400px] sm:max-w-[450px] md:max-w-[500px] lg:max-w-[600px] h-[70vh] object-cover drop-shadow-three dark:hidden dark:drop-shadow-none"
        />
        <img
          src="/images/about/image.png"
          alt="about-image"
          className="hidden dark:block w-full max-w-[400px] sm:max-w-[450px] md:max-w-[500px] lg:max-w-[600px] h-[70vh] object-cover drop-shadow-three dark:drop-shadow-none"
        />
      </div>
    </div>
  </div>
